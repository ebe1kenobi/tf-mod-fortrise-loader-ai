...
namespace TFModFortRiseLoaderAI
{
  public static class KeyboardConfigs {
    ...
    static KeyboardConfigs() {
      ...
      Configs[j].Jump = new Keys[] { Keys.NumPad1, Keys.D1 }; 
      ...
      Configs[j].Jump = new Keys[] { Keys.NumPad2, Keys.D2 };
      ...
      Configs[j].Jump = new Keys[] { Keys.NumPad3, Keys.D3 };
      ...
      Configs[j].Jump = new Keys[] { Keys.NumPad4, Keys.D4 };
      ...
      Configs[j].Jump = new Keys[] { Keys.NumPad5, Keys.D5 }; 
      ...
      Configs[j].Jump = new Keys[] { Keys.NumPad6, Keys.D6 };
      ...
      Configs[j].Jump = new Keys[] { Keys.NumPad7, Keys.D7 };
      ...
      Configs[j].Jump = new Keys[] { Keys.NumPad8, Keys.D8 };
